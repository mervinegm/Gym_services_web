function welcome() {
  fetch(
    ...
    .then((data) => {
      ...
      const urlServiceLogo = data.includes.Asset[0].fields.file.url;
...
function getServices() {
  return fetch(
    "https://cdn.contentful.com/spaces/8r00ukyh4hkq/environments/master/entries?access_token=NIjEBRySV05-TekofMQbtnzr3pMwxmgVWomAnY-JsRU&content_type=m4portfolio"
  )
    .then((response) => response.json())
    .then((data) => {
      console.log(data);
